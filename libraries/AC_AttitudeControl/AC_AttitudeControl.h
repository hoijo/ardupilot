...
public:
    AC_AttitudeControl(AP_AHRS_View &ahrs,
                       ...
                       AP_Motors &motors,
                       float dt) : _p_angle_roll(AC_ATTITUDE_CONTROL_ANGLE_P),
    ...
    float second_conroller_roll(float output);
    float second_conroller_pitch(float output);
    float second_conroller_yaw(float output);
