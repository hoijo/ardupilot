...
void AC_AttitudeControl_Multi::rate_controller_run()
{
    ...
    // float control_putput_roll = get_rate_roll_pid().update_all(_ang_vel_body.x, gyro_latest.x, _motors.limit.roll) + _actuator_sysid.x;
    // _motors.set_roll( second_conroller_roll(control_putput_roll) );
    ...
    // float control_putput_pitch = get_rate_pitch_pid().update_all(_ang_vel_body.y, gyro_latest.y, _motors.limit.pitch) + _actuator_sysid.y;
    // _motors.set_pitch(second_conroller_pitch(control_putput_pitch) );
    _motors.set_pitch_ff(get_rate_pitch_pid().get_ff());

    _motors.set_yaw(get_rate_yaw_pid().update_all(_ang_vel_body.z, gyro_latest.z, _motors.limit.yaw) + _actuator_sysid.z);
    // float control_putput_yaw = get_rate_yaw_pid().update_all(_ang_vel_body.z, gyro_latest.z, _motors.limit.yaw) + _actuator_sysid.z;
    // _motors.set_yaw(second_conroller_yaw(control_putput_yaw) );
