...
float AC_AttitudeControl::second_conroller_roll(float output)
{
...
float AC_AttitudeControl::second_conroller_pitch(float output)
{
    output = constrain_float(output, -1.0f, 1.0f);
...
float AC_AttitudeControl::second_conroller_yaw(float output)
{
    output = constrain_float(output, -1.0f, 1.0f);
