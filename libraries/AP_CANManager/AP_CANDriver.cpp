...
const AP_Param::GroupInfo AP_CANManager::CANDriver_Params::var_info[] = {
    ...
    // @Values: 0:Disabled,1:DroneCAN,2:MW_AHRS,3:ToshibaCAN,4:PiccoloCAN,5:CANTester,6:EFI_NWPMU,7:USD1,8:KDECAN,10:Scripting,11:Benewake
    // @User: Advanced
    // @RebootRequired: True
    AP_GROUPINFO("PROTOCOL", 1, AP_CANManager::CANDriver_Params, _driver_type, AP_CANManager::Driver_Type_MW_AHRS),
